    ...
    <Navbar>
      <>
        ...
        <div className="flex flex-col-reverse md:flex-row">
          <div className="w-screen md:w-1/2 shadow-xl bg-gray-50 py-6">
            {/* Add a new address */}
            <form
              className="px-5 py-5"
              noValidate
            ...
            <div className="px-5 py-5">
              ...
              <ul role="list" className="">
                {user.addresses.map((address, index) => (
                  <li
                    key={index}
                    className="flex justify-between gap-x-6 py-5 border-solid border-black border-2 my-5 px-3"
                  >
                    <div className="flex min-w-0 gap-x-4">
                      <input
                        id="address"
              ...
              <div className="mt-10 space-y-10">
                <fieldset>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600">
                    We only support payment via Card.
                  </p>
                  {/* payment methods */}
                  {/* <div className="mt-6 space-y-6">
                      <div className="flex items-center gap-x-3">
          ...
          <div className="w-screen md:w-1/2 h-full">
            <div className="lg:col-span-2">
              <div className="mx-auto mt-20 max-w-7xl px-4 sm:px-6 lg:px-8">
                <h1 className="font-bold text-xl mb-5 text-center">Summary</h1>
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                  <div className="flow-root">
                    <ul role="list" className="-my-6 divide-y divide-gray-200">
                      {items.map((item) => (
