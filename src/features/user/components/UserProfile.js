...
export default function UserProfile() {
  ...
  return (
    <div>
      <div className="w-full h-72 p-4 relative">
        <img
          src="https://b.zmtcdn.com/data/cover_images/decdaea00d7860918d9ef918611514521548143953.jpeg"
          className="w-full h-full object-cover"
        />
        {/* Black overlay */}
        <div className="absolute inset-0 bg-black opacity-40 m-4 z-10"></div>
        <div className="w-full flex flex-col md:flex-row justify-between items-center absolute top-24 text-white z-20 px-32">
          <div>
            <h1 className="text-2xl">
              {userInfo.name ? userInfo.name : "New User"}
            </h1>
            <h3 className="text-l">{userInfo.email}</h3>
          </div>
          <button className="bg-red-500 p-2 rounded-lg w-28 h-10">
            Edit Profile
          </button>
        </div>
      </div>
